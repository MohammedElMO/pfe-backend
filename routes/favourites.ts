...
import {
  CreateFavouriteMedicines,
  CreateFavouritePharmacy,
  deleteFromFavMedicines,
  deleteFromFavParmacies,
  getFavouriteMedicines,
  getFavouriteMedicinesIds,
  getFavouritePharmacies,
} from "../controllers/favourites/favourite-medicines.middleware";
